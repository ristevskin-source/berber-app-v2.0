...
# ============================================================
# КАЛЕНДАР - РАДНА ВЕРЗИЈА (БЕЗ ФИЛТЕРА)
# ============================================================
...
with tab2:
    if not st.session_state['admin_authenticated']:
        ...
        rows = c.fetchall()
        conn.close()
        # BEZ FILTERA - prikazuju se svi termini (uključujući i naplaćene)
        if rows:
            grupe = {}
